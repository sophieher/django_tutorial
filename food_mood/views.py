...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        return render_to_response('food_mood/signup.html', {
            'user_form': user_form,
...
def profile(request):
    ...
    # We make use of the shortcut function to make our lives easier.
    # Note that the first parameter is the template we wish to use.
    return render_to_response('food_mood/profile.html', context)
...
def add_food_mood(request):
    ...
    if request.method == 'POST':
        ...
        if add_form.is_valid():
            ...
            entry.save()
            return HttpResponseRedirect('/food_mood/entries')
        else:
    ...
    return render_to_response('food_mood/add.html', {'add_form': add_form}, context)
